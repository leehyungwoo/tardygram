          ...
          <div className="container">
            <div className="row no-gutters slider-text align-items-end justify-content-center">
              <div className="col-md-9 ftco-animate pb-5 text-center">
                <h1 className="mb-3 bread">Lifestyle</h1>
                <p className="breadcrumbs"><span className="mr-2">Home <i className="ion-ios-arrow-forward" /></span> <span>Lifestyle <i className="ion-ios-arrow-forward" /></span></p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-9">
                <div className="row">
                  <div className="col-md-6 col-lg-12 ftco-animate">
                    <div className="blog-entry d-lg-flex">
                      ...
                      <div className="text px-md-4 px-lg-5 half pt-3">
                        ...
                        <p className="mb-0"><a href="single.html" className="btn btn-primary">Read More <span className="icon-arrow_forward ml-4" /></a></p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-6 col-lg-12 ftco-animate">
                    <div className="blog-entry d-lg-flex">
                      <div className="half">
                        <a href="single.html" className="img d-flex align-items-end" style={{backgroundImage: `url(${image_2})`}}>
                          <div className="overlay" />
                        </a>
                      </div>
                      <div className="text px-md-4 px-lg-5 half pt-3">
                  ...
                  <div className="col-md-6 col-lg-12 ftco-animate">
                    <div className="blog-entry d-lg-flex">
                      <div className="half">
                        <a href="single.html" className="img d-flex align-items-end" style={{backgroundImage: `url(${image_6})`}}>
                          <div className="overlay" />
                        </a>
                      </div>
                      <div className="text px-md-4 px-lg-5 half pt-3">
