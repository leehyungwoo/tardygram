          ...
          <div className="container">
            <div className="row no-gutters slider-text align-items-end justify-content-center">
              <div className="col-md-9 ftco-animate pb-5 text-center">
                <h1 className="mb-3 bread">Foods</h1>
                <p className="breadcrumbs"><span className="mr-2">Home <i className="ion-ios-arrow-forward" /></span> <span>Foods <i className="ion-ios-arrow-forward" /></span></p>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="row">
              <div className="col-lg-9">
                <div className="row">
                  ...
                  <div className="col-md-4 ftco-animate">
                    <div className="blog-entry">
                      <a href="single.html" className="img-2"><img src={blog_4} className="img-fluid" alt="Colorlib Template" /></a>
                      <div className="text pt-3">
                        <p className="meta d-flex"><span className="pr-3">Dessert</span><span className="ml-auto pl-3">March 01, 2018</span></p>
                        <h3><a href="single.html">Tasty &amp; Delicious Foods</a></h3>
                        <p className="mb-0"><a href="single.html" className="btn btn-black py-2">Read More <span className="icon-arrow_forward ml-4" /></a></p>
                  ...
                  <div className="col-md-4 ftco-animate">
                    <div className="blog-entry">
                      <a href="single.html" className="img-2"><img src={blog_5} className="img-fluid" alt="Colorlib Template" /></a>
                      <div className="text pt-3">
                        <p className="meta d-flex"><span className="pr-3">Dessert</span><span className="ml-auto pl-3">March 01, 2018</span></p>
                        <h3><a href="single.html">Tasty &amp; Delicious Foods</a></h3>
                        <p className="mb-0"><a href="single.html" className="btn btn-black py-2">Read More <span className="icon-arrow_forward ml-4" /></a></p>
                  ...
                  <div className="col-md-4 ftco-animate">
                    <div className="blog-entry">
                      <a href="single.html" className="img-2"><img src={blog_6} className="img-fluid" alt="Colorlib Template" /></a>
                      <div className="text pt-3">
                        <p className="meta d-flex"><span className="pr-3">Dessert</span><span className="ml-auto pl-3">March 01, 2018</span></p>
                        <h3><a href="single.html">Tasty &amp; Delicious Foods</a></h3>
                        <p className="mb-0"><a href="single.html" className="btn btn-black py-2">Read More <span className="icon-arrow_forward ml-4" /></a></p>
                  ...
                  <div className="col-md-4 ftco-animate">
                    <div className="blog-entry">
                      <a href="single.html" className="img-2"><img src={blog_7} className="img-fluid" alt="Colorlib Template" /></a>
                      <div className="text pt-3">
                        <p className="meta d-flex"><span className="pr-3">Dessert</span><span className="ml-auto pl-3">March 01, 2018</span></p>
                        <h3><a href="single.html">Tasty &amp; Delicious Foods</a></h3>
                        <p className="mb-0"><a href="single.html" className="btn btn-black py-2">Read More <span className="icon-arrow_forward ml-4" /></a></p>
                  ...
                  <div className="col-md-4 ftco-animate">
                    <div className="blog-entry">
                      <a href="single.html" className="img-2"><img src={blog_8} className="img-fluid" alt="Colorlib Template" /></a>
                      <div className="text pt-3">
                        <p className="meta d-flex"><span className="pr-3">Dessert</span><span className="ml-auto pl-3">March 01, 2018</span></p>
                        <h3><a href="single.html">Tasty &amp; Delicious Foods</a></h3>
                        <p className="mb-0"><a href="single.html" className="btn btn-black py-2">Read More <span className="icon-arrow_forward ml-4" /></a></p>
                  ...
                  <div className="col-md-4 ftco-animate">
                    <div className="blog-entry">
                      <a href="single.html" className="img-2"><img src={blog_9} className="img-fluid" alt="Colorlib Template" /></a>
                      <div className="text pt-3">
                        <p className="meta d-flex"><span className="pr-3">Dessert</span><span className="ml-auto pl-3">March 01, 2018</span></p>
                        <h3><a href="single.html">Tasty &amp; Delicious Foods</a></h3>
                        <p className="mb-0"><a href="single.html" className="btn btn-black py-2">Read More <span className="icon-arrow_forward ml-4" /></a></p>
