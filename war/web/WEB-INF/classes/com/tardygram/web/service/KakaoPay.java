...
public class KakaoPay {
    ...
    public String kakaoPayReady(HashMap<String, String> data) {
        ...
        params.add("approval_url", "http://52.79.50.149/kakaoPaySuccess");    //결제성공시 redirect url
        params.add("cancel_url", "http://52.79.50.149/kakaoPayCancel");       //결제취소시 redirect url
        params.add("fail_url", "http://52.79.50.149/kakaoPaySuccessFail");    //결제실패시 redirect url
